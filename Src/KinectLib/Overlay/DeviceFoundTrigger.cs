...
namespace Chimera.Kinect.Overlay {
    public class DeviceFoundFactory : ITriggerFactory {
    ...
    public class DeviceFoundTrigger : TriggerBase, ITrigger {
        ...
        public DeviceFoundTrigger() {
            Nui.DeviceConnected += new ChangeDelegate(Nui_DeviceFound);
        }

        void Nui_DeviceFound() {
            Trigger();
        }
    }
}
